...
// liftInstF2XM1 lifts the given x86 F2XM1 instruction to LLVM IR, emitting code
// to f.
...
// liftInstFABS lifts the given x86 FABS instruction to LLVM IR, emitting code
// to f.
...
// liftInstFADD lifts the given x86 FADD instruction to LLVM IR, emitting code
// to f.
...
// liftInstFADDP lifts the given x86 FADDP instruction to LLVM IR, emitting code
// to f.
...
// liftInstFCOM lifts the given x86 FCOM instruction to LLVM IR, emitting code
// to f.
...
// liftInstFCOMI lifts the given x86 FCOMI instruction to LLVM IR, emitting code
// to f.
...
// liftInstFCOMIP lifts the given x86 FCOMIP instruction to LLVM IR, emitting
// code to f.
...
// liftInstFCOMP lifts the given x86 FCOMP instruction to LLVM IR, emitting code
// to f.
...
// liftInstFCOMPP lifts the given x86 FCOMPP instruction to LLVM IR, emitting
// code to f.
...
// liftInstFCOS lifts the given x86 FCOS instruction to LLVM IR, emitting code
// to f.
...
// liftInstFDECSTP lifts the given x86 FDECSTP instruction to LLVM IR, emitting
// code to f.
...
// liftInstFDIV lifts the given x86 FDIV instruction to LLVM IR, emitting code
// to f.
...
// liftInstFDIVP lifts the given x86 FDIVP instruction to LLVM IR, emitting code
// to f.
...
// liftInstFDIVR lifts the given x86 FDIVR instruction to LLVM IR, emitting code
// to f.
...
// liftInstFDIVRP lifts the given x86 FDIVRP instruction to LLVM IR, emitting
// code to f.
...
// liftInstFFREE lifts the given x86 FFREE instruction to LLVM IR, emitting code
// to f.
...
// liftInstFIADD lifts the given x86 FIADD instruction to LLVM IR, emitting code
// to f.
...
// liftInstFICOM lifts the given x86 FICOM instruction to LLVM IR, emitting code
// to f.
...
// liftInstFICOMP lifts the given x86 FICOMP instruction to LLVM IR, emitting
// code to f.
...
// liftInstFIDIV lifts the given x86 FIDIV instruction to LLVM IR, emitting code
// to f.
...
// liftInstFIDIVR lifts the given x86 FIDIVR instruction to LLVM IR, emitting
// code to f.
...
// liftInstFINCSTP lifts the given x86 FINCSTP instruction to LLVM IR, emitting
// code to f.
...
// liftInstFISUB lifts the given x86 FISUB instruction to LLVM IR, emitting code
// to f.
...
// liftInstFISUBR lifts the given x86 FISUBR instruction to LLVM IR, emitting
// code to f.
...
// liftInstFLD1 lifts the given x86 FLD1 instruction to LLVM IR, emitting code
// to f.
...
// liftInstFLDCW lifts the given x86 FLDCW instruction to LLVM IR, emitting code
// to f.
...
// liftInstFLDENV lifts the given x86 FLDENV instruction to LLVM IR, emitting
// code to f.
...
// liftInstFLDL2E lifts the given x86 FLDL2E instruction to LLVM IR, emitting
// code to f.
...
// liftInstFLDL2T lifts the given x86 FLDL2T instruction to LLVM IR, emitting
// code to f.
...
// liftInstFLDLG2 lifts the given x86 FLDLG2 instruction to LLVM IR, emitting
// code to f.
...
// liftInstFLDLN2 lifts the given x86 FLDLN2 instruction to LLVM IR, emitting
// code to f.
...
// liftInstFLDPI lifts the given x86 FLDPI instruction to LLVM IR, emitting code
// to f.
...
// liftInstFLDZ lifts the given x86 FLDZ instruction to LLVM IR, emitting code
// to f.
...
// liftInstFMUL lifts the given x86 FMUL instruction to LLVM IR, emitting code
// to f.
...
// liftInstFMULP lifts the given x86 FMULP instruction to LLVM IR, emitting code
// to f.
...
// liftInstFNCLEX lifts the given x86 FNCLEX instruction to LLVM IR, emitting
// code to f.
...
// liftInstFNINIT lifts the given x86 FNINIT instruction to LLVM IR, emitting
// code to f.
...
// liftInstFNOP lifts the given x86 FNOP instruction to LLVM IR, emitting code
// to f.
...
// liftInstFNSAVE lifts the given x86 FNSAVE instruction to LLVM IR, emitting
// code to f.
...
// liftInstFNSTCW lifts the given x86 FNSTCW instruction to LLVM IR, emitting
// code to f.
...
// liftInstFNSTENV lifts the given x86 FNSTENV instruction to LLVM IR, emitting
// code to f.
...
// liftInstFNSTSW lifts the given x86 FNSTSW instruction to LLVM IR, emitting
// code to f.
...
// liftInstFPATAN lifts the given x86 FPATAN instruction to LLVM IR, emitting
// code to f.
...
// liftInstFPREM lifts the given x86 FPREM instruction to LLVM IR, emitting code
// to f.
...
// liftInstFPREM1 lifts the given x86 FPREM1 instruction to LLVM IR, emitting
// code to f.
...
// liftInstFPTAN lifts the given x86 FPTAN instruction to LLVM IR, emitting code
// to f.
...
// liftInstFRNDINT lifts the given x86 FRNDINT instruction to LLVM IR, emitting
// code to f.
...
// liftInstFRSTOR lifts the given x86 FRSTOR instruction to LLVM IR, emitting
// code to f.
...
// liftInstFSCALE lifts the given x86 FSCALE instruction to LLVM IR, emitting
// code to f.
...
// liftInstFSIN lifts the given x86 FSIN instruction to LLVM IR, emitting code
// to f.
...
// liftInstFSINCOS lifts the given x86 FSINCOS instruction to LLVM IR, emitting
// code to f.
...
// liftInstFSQRT lifts the given x86 FSQRT instruction to LLVM IR, emitting code
// to f.
...
// liftInstFSUBP lifts the given x86 FSUBP instruction to LLVM IR, emitting code
// to f.
...
// liftInstFSUBR lifts the given x86 FSUBR instruction to LLVM IR, emitting code
// to f.
...
// liftInstFSUBRP lifts the given x86 FSUBRP instruction to LLVM IR, emitting
// code to f.
...
// liftInstFTST lifts the given x86 FTST instruction to LLVM IR, emitting code
// to f.
...
// liftInstFUCOM lifts the given x86 FUCOM instruction to LLVM IR, emitting code
// to f.
...
// liftInstFUCOMI lifts the given x86 FUCOMI instruction to LLVM IR, emitting
// code to f.
...
// liftInstFUCOMIP lifts the given x86 FUCOMIP instruction to LLVM IR, emitting
// code to f.
...
// liftInstFUCOMP lifts the given x86 FUCOMP instruction to LLVM IR, emitting
// code to f.
...
// liftInstFUCOMPP lifts the given x86 FUCOMPP instruction to LLVM IR, emitting
// code to f.
...
// liftInstFWAIT lifts the given x86 FWAIT instruction to LLVM IR, emitting code
// to f.
...
// liftInstFXAM lifts the given x86 FXAM instruction to LLVM IR, emitting code
// to f.
...
// liftInstFXTRACT lifts the given x86 FXTRACT instruction to LLVM IR, emitting
// code to f.
...
// liftInstFYL2X lifts the given x86 FYL2X instruction to LLVM IR, emitting code
// to f.
...
// liftInstFYL2XP1 lifts the given x86 FYL2XP1 instruction to LLVM IR, emitting
// code to f.
